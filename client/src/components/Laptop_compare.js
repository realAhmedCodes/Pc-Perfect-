...
export const LaptopCompare = () => {
  ...
  const compareHandle = () => {
    ...
    const selValueData2 = laptops?.find((x) => x.model === selectedValue2);
    ...
    <div className={styles.main_div}>
      <div className={styles.search_div}>
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField {...params} label="Search laptop 1" />
          )}
        />
        ...
        <Autocomplete
          ...
          className={styles.autocomplete}
          renderInput={(params) => (
            <TextField {...params} label="Search Laptop 2" />
          )}
        />
      </div>
      {tableBtn === true ? (
