...
export const CaseCompare = () => {
  ...
  const compareHandle = () => {
    ...
    const selValueData2 = cases?.find((x) => x.model === selectedValue2);
    ...
    <div className={styles.main_div}>
      <div className={styles.search_div}>
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField {...params} label="Search Casing 1" />
          )}
        />
        ...
        <Autocomplete
          ...
          className={styles.autocomplete}
          renderInput={(params) => (
            <TextField {...params} label="Search Casing 2" />
          )}
        />
      </div>
      {tableBtn === true ? (
              ...
              <Table sx={{ minWidth: 400 }} size="small">
                <TableHead>
                  <TableRow className={styles.row_text}>
                    ...
                    <TableCell>Casing 1</TableCell>
                    <TableCell>Casing 2</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
