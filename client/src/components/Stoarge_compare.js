...
export const StorageCompare = () => {
  ...
  const compareHandle = () => {
    ...
    const selValueData2 = storages?.find((x) => x.model === selectedValue2);
    ...
    <div className={styles.main_div}>
      <div className={styles.search_div}>
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField {...params} label="Search Storage 1" />
          )}
        />
        ...
        <Autocomplete
          ...
          className={styles.autocomplete}
          renderInput={(params) => (
            <TextField {...params} label="Search Storage 2" />
          )}
        />
      </div>
      {tableBtn === true ? (
