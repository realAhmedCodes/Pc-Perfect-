...
export const MoboCompare = () => {
  ...
  const compareHandle = () => {
    ...
    const selValueData2 = mobos?.find((x) => x.model === selectedValue2);
    ...
    <div className={styles.main_div}>
      <div className={styles.search_div}>
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField {...params} label="Search Motherboard 1" />
          )}
        />
        ...
        <Autocomplete
          ...
          className={styles.autocomplete}
          renderInput={(params) => (
            <TextField {...params} label="Search Motherboard 2" />
          )}
        />
      </div>
      {tableBtn === true ? (
              ...
              <Table sx={{ minWidth: 400 }} size="small">
                <TableHead>
                  <TableRow className={styles.row_text}>
                    ...
                    <TableCell>Motherboard 1</TableCell>
                    <TableCell>Motherboard 2</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
